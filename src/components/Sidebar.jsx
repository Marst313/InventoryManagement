...
const Sidebar = () => {
  return (
    <aside className="h-screen float-left w-56 border-r-[1px] aside-shadow overflow-hidden ">
      <div className="h-1/6 flex  gap-3 font-semibold text-lg px-5 pt-10 items-center">
